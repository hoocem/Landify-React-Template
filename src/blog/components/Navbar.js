...
class Breadcrumb extends Component{
    render(){
        return(
            <div className="rt-site-header rt-sticky">
                <nav className="navbar navbar-expand-lg rt-one-page-menu rt-nav-dark">
                    <div className="container">
                
                        <a href={`${process.env.PUBLIC_URL}/`} className="brand-logo"><img src="assets/images/logo/logo.png" alt=""/></a>
                        <a href={`${process.env.PUBLIC_URL}/`} className="sticky-logo"><img src="assets/images/logo/logo.png" alt=""/></a>
                        ...
                        <div className="collapse navbar-collapse" id="siteNav">
                            ...
                            <div className="rt-menu-tolls">
                                <a href="#!" className="rt-btn rt-secondary pill text-uppercase">Download</a>
                            </div>
                        </div>
